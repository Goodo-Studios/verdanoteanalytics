              ...
              <div key={w.ad_id} className="glass-panel p-4 space-y-3">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-3 mt-1">
                    <span className="font-data text-[17px] font-bold text-primary tabular-nums">{fmt(w.roas, "", "x")} ROAS</span>
                ...
                <div className="px-5 pb-4 pt-1 border-t border-border-light">
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-4">
                    ...
                    <div className="text-center p-3 bg-muted/30 rounded-lg">
                      ...
                      <div className="font-data text-[17px] font-semibold tabular-nums">{fmt(a.win_rate, "", "%")}</div>
                    </div>
                  </div>
