        ...
        <div className="relative w-full">
          ...
          {adLibraryUrl && imgLoaded && (
            <a
              ...
              className="absolute bottom-2 right-2 z-10 inline-flex items-center gap-1.5 bg-white/90 hover:bg-white text-[11px] font-medium text-slate-700 rounded-md px-2.5 py-1.5 shadow-sm transition-colors"
