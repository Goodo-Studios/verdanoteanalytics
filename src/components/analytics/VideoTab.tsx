        ...
        <TableBody>
          {sorted.map(c => (
            <TableRow key={c.ad_id} className="cursor-pointer" onClick={() => onCreativeClick?.(c)}>
              ...
              <TableCell className="text-right font-data text-[13px] tabular-nums">{pct(c.hook_rate)}</TableCell>
              <TableCell className="text-right font-data text-[13px] tabular-nums">{pct(c.hold_rate_val)}</TableCell>
