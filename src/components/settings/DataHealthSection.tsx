          ...
          <TableBody>
            {(health || []).map((row) => (
              <TableRow key={row.id}>
                ...
                <TableCell className="font-data text-[13px] text-charcoal text-right">{row.creative_count}</TableCell>
                <TableCell className="font-data text-[13px] text-charcoal text-right">{row.with_spend}</TableCell>
