...
function MetricRow({ label, metaVal, snapshotVal, dailyVal, format = "number" }: {
  ...
  return (
    <div className="grid grid-cols-5 gap-2 py-2 border-b border-border/50 last:border-0 items-center">
      ...
      <span className="font-data text-[17px] text-foreground text-right tabular-nums">{fmt(mv)}</span>
      <span className="font-data text-[17px] text-muted-foreground text-right tabular-nums">{fmt(snapshotVal ?? 0)}</span>
      <span className="font-data text-[17px] text-foreground text-right tabular-nums font-semibold">{fmt(dv)}</span>
          ...
          <div className="rounded-md border border-border overflow-hidden">
            ...
            <div className="px-4">
              ...
              <div className="grid grid-cols-5 gap-2 py-2 items-center">
                ...
                <span className="font-data text-[17px] text-foreground text-right tabular-nums">{result.meta.ad_count ?? "—"}</span>
                <span className="font-data text-[17px] text-muted-foreground text-right tabular-nums">{result.verdanote_snapshot.creative_count}</span>
                <span className="font-data text-[17px] text-foreground text-right tabular-nums font-semibold">{result.verdanote_daily.ad_count}</span>
