  ...
  return (
    <AppLayout>
      <div className="flex h-full">
        <CollectionSidebar selectedBoardId={selectedBoardId} onSelect={setSelectedBoardId} />
          ...
          <div className="flex-1 overflow-y-auto px-6 pb-6">
            {isLoading ? (
              ...
              <div className="flex flex-col items-center justify-center py-20 text-center">
                ...
                <p className="font-body text-[13px] text-sage mb-4">Start building your swipe file by saving ads you find inspiring.</p>
                <Button onClick={() => setShowSaveModal(true)} size="sm" className="gap-1.5">
