                ...
                <Card key={acc.id} className="p-4 space-y-3 hover:shadow-card-hover transition-shadow">
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    <div>
                      ...
                      <p className="font-data text-[17px] font-medium tabular-nums text-foreground">{fmt$(mtd)}</p>
                      {prior > 0 && (
                    ...
                    <div>
                      ...
                      <p className="font-data text-[17px] font-medium tabular-nums text-foreground">{avgRoas.toFixed(2)}x</p>
                    ...
                    <div>
                      ...
                      <p className="font-data text-[17px] font-medium tabular-nums text-foreground">{active.length}</p>
                    </div>
                  </div>
                ...
                {topWinners.map((c: any, i) => (
                  <div key={c.ad_id} className="flex items-center gap-3 py-1.5">
                    ...
                    <div className="text-right shrink-0">
                      <p className="font-data text-[17px] font-medium text-primary tabular-nums">{Number(c.roas).toFixed(2)}x</p>
